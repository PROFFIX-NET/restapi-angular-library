...
/**
 * Ruft die Buchungen aus KRE/Buchung ab
 */
@Injectable()
export class PxBuchungService implements PxGettableAllServiceInterface<PxBuchung>, PxGettableByIdServiceInterface<PxBuchung>,
  ...
  /**
   * Gibt alle Buchungen flach zurück
   * @param params Object mit den Parametern welche dem Request mitgegeben werden sollen
   */
  public getAllFlat(params?: PxGlobalQueryParameter): Observable<PxBuchungFlat[]> {
    return this.httpService.get<PxBuchungFlat[]>(this.endpoint + "/Flat", params);
  }

  /**
   * Gibt eine Buchung flach zurück
   * @param buchungsNr Buchung-Nr welche flach abgerufen wird
   * @param params Object mit den Parametern welche dem Request mitgegeben werden sollen
   */
  public getFlat(buchungsNr: number, params?: PxGlobalQueryParameter): Observable<PxBuchungFlat> {
    return this.httpService.get<PxBuchungFlat>(this.endpoint + "/" + buchungsNr + "/Flat", params);
  }
